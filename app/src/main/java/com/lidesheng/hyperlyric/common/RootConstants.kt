...
object RootConstants {
    ...
    const val DEFAULT_HOOK_STATUS_BAR_LYRIC_ICON_SIZE_DP = 16
    ...
    const val STATUS_BAR_LYRIC_GESTURE_ACTION_OPEN_MEDIA_APP = 3
    ...
    const val ISLAND_ALBUM_COVER_STYLE_MONOCHROME = 5
